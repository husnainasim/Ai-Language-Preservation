        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-muted-foreground">Policy Parameters</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold">1000+</h3>
              <p className="text-muted-foreground">Simulation Scenarios</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background" >
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Four simple steps to analyze policy impacts
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background" >
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-muted-foreground">
              Find answers to common questions about our policy simulation platform
            </p>
          </div>
        ...
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl">
              ...
              with AI-powered policy simulation.
            </p>
